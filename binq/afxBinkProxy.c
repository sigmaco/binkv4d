...
static void LoadLibNow(void)
{
    ...
    if (!binkw32)
    {
        ...
        AfxMakeUri(&uri, 0, "//./z/binkw64.dl_", 0);
#else
        AfxMakeUri(&uri, 0, "//./z/binkw32.dl_", 0);
#endif
#endif

        if (AfxAcquireModule(&uri, NIL, &binkw32)) AfxThrowError();
        else
        {
            afxUnit foundCnt = AfxFindSymbolAddresses(binkw32, countof(symNames), symNames, symVmt.v);
        }
    }
}
...
_AVXBINK void*/*HBINK*/ BinkOpen(const char* name, afxUnit flags)
{
    LoadLibNow();
...
_AVXBINK afxInt  BinkCopyToBuffer(void*/*HBINK*/bnk, void* dest, afxInt destpitch, afxUnit destheight, afxUnit destx, afxUnit desty, afxUnit flags)
{
    return symVmt.BinkCopyToBuffer(bnk, dest, destpitch, destheight, destx, desty, flags);
}

_AVXBINK afxInt  BinkCopyToBufferRect(void*/*HBINK*/bnk, void* dest, afxInt destpitch, afxUnit destheight, afxUnit destx, afxUnit desty, afxUnit srcx, afxUnit srcy, afxUnit srcw, afxUnit srch, afxUnit flags)
{
    return symVmt.BinkCopyToBufferRect(bnk, dest, destpitch, destheight, destx, desty, srcx, srcy, srcw, srch, flags);
}

_AVXBINK afxInt BinkGetRects(void*/*HBINK*/bnk, afxUnit flags)
{
    return symVmt.BinkGetRects(bnk, flags);
}

_AVXBINK void BinkGoto(void*/*HBINK*/bnk, afxUnit frame, afxInt flags)
{
    symVmt.BinkGoto(bnk, frame, flags);
}

_AVXBINK afxUnit  BinkGetKeyFrame(void*/*HBINK*/bnk, afxUnit frame, afxInt flags)
{
...
_AVXBINK void BinkSetVolume(void*/*HBINK*/bnk, afxUnit trackid, afxInt volume)
{
    symVmt.BinkSetVolume(bnk, trackid, volume);
}

_AVXBINK void BinkSetPan(void*/*HBINK*/bnk, afxUnit trackid, afxInt pan)
{
    symVmt.BinkSetPan(bnk, trackid, pan);
}

_AVXBINK void BinkSetMixBins(void*/*HBINK*/bnk, afxUnit trackid, afxUnit* mix_bins, afxUnit total)
{
    symVmt.BinkSetMixBins(bnk, trackid, mix_bins, total);
}

_AVXBINK void BinkSetMixBinVolumes(void*/*HBINK*/bnk, afxUnit trackid, afxUnit* vol_mix_bins, afxInt* volumes, afxUnit total)
{
...
_AVXBINK afxInt  BinkControlBackgroundIO(void*/*HBINK*/bink, afxUnit control)
{
...
_AVXBINK afxInt  BinkDoFrameAsync(void*/*HBINK*/bink, afxUnit yplane_thread_num, afxUnit other_work_thread_num)
{
...
_AVXBINK void*/*HBINKTRACK*/ BinkOpenTrack(void*/*HBINK*/bnk, afxUnit trackindex)
{
...
_AVXBINK afxUnit  BinkGetTrackData(void*/*HBINKTRACK*/bnkt, void* dest)
{
    return symVmt.BinkGetTrackData(bnkt, dest);
}

_AVXBINK afxUnit  BinkGetTrackType(void*/*HBINK*/bnk, afxUnit trackindex)
{
    return symVmt.BinkGetTrackType(bnk, trackindex);
}

_AVXBINK afxUnit  BinkGetTrackMaxSize(void*/*HBINK*/bnk, afxUnit trackindex)
{
    return symVmt.BinkGetTrackMaxSize(bnk, trackindex);
}

_AVXBINK afxUnit  BinkGetTrackID(void*/*HBINK*/bnk, afxUnit trackindex)
{
...
_AVXBINK void BinkGetRealtime(void*/*HBINK*/bink, void*/*BINKREALTIME**/run, afxUnit frames)
{
    symVmt.BinkGetRealtime(bink, run, frames);
}

_AVXBINK void BinkSetSoundTrack(afxUnit total_tracks, afxUnit* tracks)
{
...
_AVXBINK void BinkSetFrameRate(afxUnit forcerate, afxUnit forceratediv)
{
    symVmt.BinkSetFrameRate(forcerate, forceratediv);
}

_AVXBINK void BinkSetSimulate(afxUnit sim)
{
    LoadLibNow();
    symVmt.BinkSetSimulate(sim);
}

_AVXBINK void BinkSetIOSize(afxUnit iosize)
{
    LoadLibNow();
...
_AVXBINK void*/*HBINKBUFFER*/ BinkBufferOpen(void* /*HWND*/ wnd, afxUnit width, afxUnit height, afxUnit bufferflags)
{
    LoadLibNow();
...
_AVXBINK void BinkBufferBlit(void*/*HBINKBUFFER*/buf, void*/*BINKRECT**/rects, afxUnit numrects)
{
    symVmt.BinkBufferBlit(buf, rects, numrects);
}

_AVXBINK afxInt BinkBufferSetScale(void*/*HBINKBUFFER*/buf, afxUnit w, afxUnit h)
{
...
_AVXBINK afxInt BinkBufferClear(void*/*HBINKBUFFER*/buf, afxUnit RGB)
{
